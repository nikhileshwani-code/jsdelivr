...
function changeImageSrc(oldSrc, newSrc) {
  ...
  for (var i = 0; i < images.length; i++) {
      ...
      console.log(oldSrc);
      console.log(typeof(oldSrc));
      console.log(typeof(images[i].src));
      if (a == oldSrc) {
        ...
        console.log(images[i].src == oldSrc)
        for(let j = 0; j < images[i].src.length; j++) {
          console.log("inside for");
          console.log('####################################');
          console.log(images[i].src[j]);
          console.log(oldSrc[j]);
          console.log('####################################');
    // if((images[i].src)[j] !== oldSrc[j]) {
    //     console.log(`Mismatch at position ${j}: ${(images[i].src)[j]} !== ${oldSrc[j]}`);
    //     //break;
    // }
}
      }
